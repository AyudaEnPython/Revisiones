...
"""
from tkinter import Frame, Label, Entry, Button, Canvas, Toplevel, Tk, ttk, messagebox
...
class App(Frame):
    ...
    def draw_entry(self):
        self.txt_name = Entry(self.frame,font=('Arial', 12),relief="flat", background="#E7E7E7")
        self.txt_rut = Entry(self.frame,font=('Arial', 12),relief="flat", background="#E7E7E7")
        self.txt_date = Entry(self.frame,font=('Arial', 12),relief="flat", background="#E7E7E7")
        self.txt_desc = Entry(self.frame,font=('Arial', 12),relief="flat", background="#E7E7E7")
    ...
    def draw_buttons(self):
        self.btn_confirm = Button(
            ...
            relief="flat", cursor="hand1", overrelief="raise", background="#0051C8",
        )
        self.btn_cancel = Button(
            self.frame, text="Cancelar",foreground="white", borderwidth=2,
            relief="flat", cursor="hand1", overrelief="raise", background="#E81123",
        )
        self.btn_confirm.place(x=750, y=340, width=90)
        self.btn_cancel.place(x=850, y=340, width=90)

    def load_image(self):
        Label(self.frame, text="imagen", background="#314252", foreground="white").place(x=430, y=25)
    ...
    def getRow(self, event):
        ...
        btn_change = Button(pop, text="Actualizar", relief="flat", background="#00CE54", foreground="white").place(x=180, y=160, width=90)
        btn_delete = Button(pop, text="Eliminar", relief="flat", background="red", foreground="white").place(x=290, y=160, width=90)
